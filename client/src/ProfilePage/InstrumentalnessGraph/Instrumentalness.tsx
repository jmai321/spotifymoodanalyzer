...
const Instrumentalness: React.FC<{ songs: Song[] }> = ({ songs }) => {
    ...
    useEffect(() => {
        if (songs && d3Container.current) {
            ...
            svg.selectAll('.dot')
                ...
                .attr('cy', d => y(d.instrumentalness))
                .attr('r', 5)
                .attr('fill', 'yellow');
                ...
                .on('mouseover', (event, d) => {
                    ...
                    if (tooltip) {
                        ...
                        tooltip.innerHTML = 
                            ...
                            `<strong>Instrumentalness Score:</strong> ${d.instrumentalness}`;
